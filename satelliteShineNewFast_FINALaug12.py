...
plt.xticks([-10,-5,0,5,10],['2pm','7pm','12am','5am','10am'])
...
#plt.colorbar(cb,label="Number of Illuminated Satellites",ticks=[0,50,100,150,200,250,300,350,400])
plt.colorbar(cb,label="Number of Illuminated Satellites",ticks=[0,500,1000,1500,2000,2500,3000])
