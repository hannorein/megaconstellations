...
names = {"starlink":"Starlink", "oneweb":"OneWeb", "starnet":"StarNet/GW", "kuiper":"Kuiper"}

satellites = {}
satellites["starlink"] = [
    {'NPLANES':7178,'SATPP':1,'INC':30,'ALT':328},
...
satellites["kuiper"] = [
    {'NPLANES':34,'SATPP':34,'INC':51.9,'ALT':630},
